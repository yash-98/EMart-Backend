...
public class ItemModel {
	...
	public List<String> retrieveAllBrands(){
		
		try {
			return itemData.retrieveAllBrands();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			System.out.println("There was an error with trying to retrieve the brands list.");
			return null;
		}
	}
	...
	public List<String> retrieveAllTypes(){
		...
		try {
			return itemData.retrieveAllType();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			System.out.println("There was an error with trying to retrieve the types list.");
			return null;
		}
	}
